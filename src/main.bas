...
540 NEXTI:RESTORE
550 REM*** INTRO ***
570 PRINT"TERVE,OLEN KALLE JA KUTISTAN KALLOSI JA LUOTAAN TAJUNTASI TASOJA."
575 PRINT"NO NIIN - RENTOUDUHAN NIIN ALOITAMME"
576 PRINT"ISTUNNON. JOS KUITENKIN ENSIKSI ANTAISIT NIMESI TANNE REKISTERIIN."
577 PRINT
578 PRINT
581 INPUTN$:IFN$=""OR N$=" " THEN 581
590 PRINT"HIENOA ";N$;" , KERROHAN NYT MINULLE MIKA ON ONGELMASI"
600 PRINT:RETURN
610 ::
620 REM    LOPETUS
630 ::
640 K=0
650 PRINT"K E S K U S T E L U N A I H E E T"
660 FORI=0TO19:IFI+K>AMTHENGOTO720
670 PRINTI+K;"..";LEFT$(SN$(I+K,1),10);
680 PRINTTAB(16)"I";
690 FORJ=0TOAE%(I+K):PRINT"+";:NEXT
700 PRINTAE%(I+K)
710 NEXT:PRINT"JATKA...";
